! function(e, t) {
    ...
    return function(e) {
        ...
        const a = e => document.querySelector(e),
            h = e => "number" == typeof e ? "#" + ("00000" + e.toString(16)).slice(-6) : e,
            u = (e, t = 1) => {
                const i = h(e),
        ...
        function c(e) {
            for (; e.children && e.children.length > 0;) c(e.children[0]), e.remove(e.children[0]);
        ...
        r.VantaBase = class {
            constructor(e = {}) {
                if (!n) return !1;
                r.current = this,  this.resize = this.resize.bind(this), this.animationLoop = this.animationLoop.bind(this), this.restart = this.restart.bind(this);
                ...
                if (this.options = Object.assign({
                    ...
                    const e = this.el;
                    if (this.el = Object(o.f)(e), !this.el) return void a("Cannot find element", e)
                }
                ...
                i("resize", this.resize), window.requestAnimationFrame(this.resize)
            }
            setOptions(e = {}) {
                // Object.as    sign(this.options, e), this.triggerMouseMove()
            }
            prepareEl() {
                let e, t;
            ...
            destroy() {
                ...
                // e("touchstart", this.windowTouchWrapper), e("touchmove", this.windowTouchWrapper), e("scroll", this.windowMouseMoveWrapper), e("mousemove", this.windowMouseMoveWrapper), e("deviceorientation", this.windowGyroWrapper), 
                e("resize", this.resize), window.cancelAnimationFrame(this.req);
                const t = this.scene;
